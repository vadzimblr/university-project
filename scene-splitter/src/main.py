...
from presentation.api.start_scene_segmentation_action import router as start_scene_segmentation_router
...
def create_app():
    ...
    app.include_router(start_scene_segmentation_router, prefix="/api")
    return app
